...
2. Run the analysis [notebook](python/notebook/analysis.ipynb). This reads the combined event sample, applies cell resampling, and produces plots of the resampled distributions.
...
However, in realistic event samples the average cell size _k_ is small (typically only a
